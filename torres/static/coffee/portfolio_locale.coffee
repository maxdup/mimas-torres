...
app.config(['$translateProvider', ($translateProvider) ->
  ...
  $translateProvider.translations('fr', {
    ...
    'code-intro': "on porte plusieurs chapeaux quand on conçoit un niveau. Parmi les différentes disciplines, l'un de mes points forts est la programmation. Ça a été très utile pour quelques-uns de mes niveaux les plus complexes, mais il n'y avait aucune raison d'arrêter là, j'ai aussi été capable d'appliquer mes connaissances pour améliorer les outils de modding de la communauté et c'était tout aussi plaisant. Voici quelques'un des outils sur lesquels j'ai travaillé pour m'aider dans mes aventures de conception de niveaux."
